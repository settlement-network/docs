...
const config: Config = {
  ...
  tagline: 'Designing Systems to Connect Blockchains',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Settlement Network, Built with Docusaurus.`,
    },
    prism: {
